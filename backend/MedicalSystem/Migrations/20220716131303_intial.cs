            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    W_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    start_time = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    end_time = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
                    maxpatientNo = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Works_in_1", x => new { x.DID, x.W_ID });
                    table.ForeignKey(
